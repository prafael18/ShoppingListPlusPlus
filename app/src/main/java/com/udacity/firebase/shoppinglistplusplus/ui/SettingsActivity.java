...
public class SettingsActivity extends PreferenceActivity {
    ...
    public static class SortPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
             ...
             */
            bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_name_sort_order_lists_key)));
        }
        ...
        private void setPreferenceSummary(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                if (prefIndex >= 0) {
                    ...
                    editor.putString(Constants.KEY_PREF_SORT_ORDER_LISTS, stringValue).apply();
                }
            }
        }
    }
